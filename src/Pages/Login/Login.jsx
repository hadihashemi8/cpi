    ...
    <div className='bg-[url("./src/assets/images/login-bg.png")] flex items-center justify-center bg-cover  bg-no-repeat   bg-right md:bg-center w-full h-[100vh]'>
      <div className='bg-[rgba(40,_40,_40,_0.08)] shadow-[0px_0px_20px_rgba(199,199,199,0.25)] backdrop-blur-[20px] flex items-start p-4 md:px-14 justify-center rounded-[20px]  '>
        <div className='flex flex-col items-center justify-between'>
          ...
          <img className='w-[50px] mt-4' src="/./src/assets/icons/profile-circle-white.svg" alt="" />
          ...
          <div className='mt-16 flex flex-col items-center justify-between '>
            ...
            {showConfirmNumber ? (
              <div className='flex border-[1px] border-white rounded-lg py-1 px-5'>
                <img className='ml-2 w-5' src="/./src/assets/icons/sms.svg" alt="" />
              ...
              <div className='flex border-[1px] border-white rounded-lg py-1 px-5'>
                <img className='ml-2 w-5' src="/./src/assets/icons/Vector-white.svg" alt="" />
            ...
            <button onClick={() => setShowConfirmNumber(true)} className='w-full text-white bg-[#42A476] mt-8 py-3 px-24 rounded-lg drop-shadow-[0px_2px_8px_rgba(0,0,0,0.25)]'>ارسال</button>
            {showConfirmNumber && (
